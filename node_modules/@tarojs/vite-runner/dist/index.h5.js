...
const h5_2 = require("./utils/compiler/h5");
const component_1 = require("./utils/component");
function default_1(appPath, rawTaroConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        const viteCompilerContext = new h5_2.TaroCompilerContext(appPath, rawTaroConfig);
        const { taroConfig } = viteCompilerContext;
        const isProd = (0, utils_1.getMode)(taroConfig) === 'production';
        const plugins = [
            (0, h5_1.default)(viteCompilerContext),
        ];
        // legacy-plugin
        if (taroConfig.legacy && isProd) {
            plugins.push((0, plugin_legacy_1.default)({
        ...
        if (isProd) {
            ...
            // @TODO pretty print
            const server = yield (0, vite_1.createServer)(commonConfig);
            yield server.listen();
            server.printUrls();
        }
    });
