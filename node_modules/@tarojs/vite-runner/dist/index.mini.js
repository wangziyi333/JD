...
const mini_1 = __importDefault(require("./mini"));
const utils_1 = require("./utils");
const mini_2 = require("./utils/compiler/mini");
const component_1 = require("./utils/component");
function default_1(appPath, rawTaroConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        const viteCompilerContext = new mini_2.TaroCompilerContext(appPath, rawTaroConfig);
        const { taroConfig } = viteCompilerContext;
        const plugins = [
            (0, mini_1.default)(viteCompilerContext)
        ];
        // copy-plugin
        ...
        if ((0, shared_1.isFunction)(modifyComponentConfig)) {
            modifyComponentConfig(component_1.componentConfig, taroConfig);
        }
