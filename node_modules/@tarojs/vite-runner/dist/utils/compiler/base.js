...
class CompilerContext {
    ...
    processConfig() { }
    collectedDeps(rollupCtx_1, id_1, filter_1) {
        return __awaiter(this, arguments, void 0, function* (rollupCtx, id, filter, cache = new Set()) {
            if (!/\.m?[jt]sx?$/.test(id) || !filter(id) || cache.has(id))
                return cache;
            cache.add(id);
            const moduleInfo = yield rollupCtx.load({
                id,
                resolveDependencies: true,
            });
            yield Promise.all(moduleInfo.importedIds.map((importedId) => __awaiter(this, void 0, void 0, function* () {
