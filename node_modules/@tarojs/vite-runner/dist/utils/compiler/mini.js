...
const native_support_1 = require("../../mini/native-support");
...
class TaroCompilerContext extends base_1.CompilerContext {
    ...
    generateNativeComponent(rollupCtx, meta, implicitlyLoadedAfterOneOf = []) {
        ...
        rollupCtx.emitFile({
            type: 'chunk',
            id: meta.scriptPath + native_support_1.QUERY_IS_NATIVE_COMP,
            fileName: this.getScriptPath(meta.name),
            implicitlyLoadedAfterOneOf,
        });
        const source = (0, native_support_1.miniTemplateLoader)(rollupCtx, meta.templatePath, this.sourceDir);
        rollupCtx.emitFile({
            type: 'asset',
