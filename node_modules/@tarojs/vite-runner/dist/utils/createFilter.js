...
exports.createFilterWithCompileOptions = void 0;
/**
...
function createFilterWithCompileOptions(compile = {}, defaultInclude = [], defaultExclude = []) {
    if ((0, shared_1.isFunction)(compile.filter)) {
...
exports.createFilterWithCompileOptions = createFilterWithCompileOptions;
