...
const rollup_plugin_increment_1 = __importDefault(require("../common/rollup-plugin-increment"));
        ...
        config: () => __awaiter(this, void 0, void 0, function* () {
            ...
            const output = {
                entryFileNames(chunkInfo) {
                    ...
                    name = (0, utils_1.stripMultiPlatformExt)(`${name}/index${suffix}`) + taroConfig.fileType.script;
            ...
            const rollupPlugins = [
                ...
                (0, rollup_plugin_increment_1.default)({
