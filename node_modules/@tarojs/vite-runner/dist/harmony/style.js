        ...
        return {
            ...
            load(id) {
                if (isStyleRequest(id)) {
                    ...
                    if (helper_1.fs.existsSync(rawId)) {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!isStyleRequest(id)) {
                        ...
                        try {
                            ...
                            if (viteCompilerContext.loaderMeta.enableParseJSXStyle)
                                return;
                            // Note: 确保 CSS 文件已经加载
                    ...
                    const { code: css, modules, deps, map, } = yield (0, postcss_1.compileCSS)(id, raw, viteConfig, urlReplacer, isGlobalModule, taroConfig.cssVariables);
                    // if (!cssCache.has(id)) {
                    cssCache.set(id, css);
                    // }
                    // 校验css
