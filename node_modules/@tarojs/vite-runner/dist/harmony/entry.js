        ...
        load(id) {
            return __awaiter(this, void 0, void 0, function* () {
                if (viteCompilerContext && id.endsWith(exports.ENTRY_SUFFIX)) {
                    ...
                    // emit pages
                    yield Promise.all(viteCompilerContext.pages.map((page) => __awaiter(this, void 0, void 0, function* () {
                        if (page.isNative) {
                            ...
                            this.emitFile({
                                type: 'chunk',
                                id: page.scriptPath,
                                fileName: viteCompilerContext.getScriptPath(page.name + '/index' + exports.TARO_COMP_SUFFIX),
                                implicitlyLoadedAfterOneOf: [rawId]
                            });
                            yield this.load({
                                id: page.scriptPath,
                        ...
                        list.forEach((item) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (iconPath) {
                                ...
                                this.emitFile({
                                    ...
                                    source: Uint8Array.from(helper_1.fs.readFileSync(filePath))
                                });
                                if (!isFinished) {
                    ...
                    if (appConfig.darkmode && (0, shared_1.isString)(appConfig.themeLocation)) {
                        ...
                        this.emitFile({
                            ...
                            source: Uint8Array.from(helper_1.fs.readFileSync(themePath))
                        });
                        if (!isFinished) {
