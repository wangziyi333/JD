...
class RenderParser extends base_1.default {
    ...
    generate(fileName, name = 'TaroRender', resolve) {
        ...
        this.context.nativeComponents.forEach((meta) => {
            ...
            if (meta.isPackage) {
                ...
                const etx = node_path_1.default.extname(meta.scriptPath);
                const nativePath = node_path_1.default
        ...
        if ((0, shared_1.isFunction)(modifyHarmonyRenderChild)) {
            try {
...
export { createChildItem, createLazyChildren }`,
        ...
        if ((0, shared_1.isFunction)(modifyHarmonyRenderCode)) {
            try {
    ...
    generateComponentCreated({ namePrefix = 'Taro', name = '', condition = '', type = 'TaroAny', args = ['createLazyChildren'], extra = '', fullArgument = '', }) {
  ...
  ${name}(${callArguments})${extra}
    ...
    generateNativeComponentNamesInit() {
        if (this.context.nativeComponents.size === 0)
            return '';
        const commentsList = [];
