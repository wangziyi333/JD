...
`;
    ...
    parse(rawId, app, resolve) {
        ...
        const importList = [
            ...
            `import createComponent, { config } from "./${node_path_1.default.basename(rawId, node_path_1.default.extname(rawId))}/index${entry_1.TARO_COMP_SUFFIX}"`,
            __classPrivateFieldGet(this, _Parser_setReconcilerPost, "f"),
        ];
        if ((0, shared_1.isFunction)(app.modifyAppImport)) {
    ...
    parseEntry(rawId, app) {
        ...
        return (0, shared_1.isFunction)(modifyEntryFile) ? modifyEntryFile.call(this, 'app', rawId, rawCode, app) : rawCode;
    }
}
