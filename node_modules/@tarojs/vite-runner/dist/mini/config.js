...
function default_1(viteCompilerContext) {
    ...
    function getManualChunks() {
        ...
        const babelDeps = [/node_modules[\\/]@babel[\\/]/];
        ...
        switch (framework) {
            case 'react':
                return (id, { getModuleInfo }) => {
                    ...
                    if (testByReg2DExpList([babelDeps, commonjsHelpersDeps])(id))
                        return 'babelHelpers';
                    if (testByReg2DExpList([taroDeps, reactRelatedDeps, tslibDeps])(id))
                        return 'taro';
            ...
            case 'vue3':
                return (id, { getModuleInfo }) => {
                    ...
                    if (testByReg2DExpList([babelDeps])(id))
                        return 'babelHelpers';
