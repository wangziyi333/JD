        ...
        load(id) {
            ...
            if (isEntry) {
                ...
                const getTabbarIconPath = (iconPath) => {
                    return isProd
                        ? node_path_1.default.posix.join('/', taroConfig.staticDirectory, 'images', node_path_1.default.basename(iconPath))
                        : iconPath.replace(/^./, '');
                };
                const emitTabbarIcon = (sourceDir, iconPath) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const fileName = node_path_1.default.posix.join(taroConfig.staticDirectory, 'images', node_path_1.default.basename(iconPath));
