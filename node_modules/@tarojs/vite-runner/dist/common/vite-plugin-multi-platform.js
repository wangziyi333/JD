        ...
        resolveId(source, importer, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const multiExt of multiExtList) {
                    resolution = yield this.resolve(node_path_1.default.resolve(node_path_1.default.dirname(importer), `${node_path_1.default.join(dir, basename)}${multiExt}`), importer, Object.assign(Object.assign({}, options), { skipSelf: true }));
                    if (resolution)
                        break;
                }
                if (!resolution) {
